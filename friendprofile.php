<?php
    ...
    if(isset($_SESSION["uemail"])){ 
		...
		JOIN user_profession ON user_education.uid=user_profession.uid where user_profile.uid='$uid'";
  ...
  overflow: auto;}
	...
	<h3><?php echo $row['name'];  echo"<br>"; ?>
       ...
       $con=mysqli_connect("localhost","root","15061994","image"); 
		if($con==FALSE) {echo"Database Connection error in file friendprofile.php";}
      ...
      echo "<td><br>"; echo '<img src="'.$imageData.'" height="130" width="130" radius="10" />';echo"</td>"; ?>
	</div>
	<div class="leftbar">
	<a href="editprofile.php">Want to edit profile?</a><br>
        ...
        <form action="findfriends.php" method="GET">
            <input type="name" name="key" style='width:90px;'>
        ...
        <div class="pagecontent">
            ...
            <?php 
           /*if($row['imgtype']=='blank'){
                echo "<td><img src='images/unknown.jpg'/></td>";
            }*/
            { echo "<td>";
                echo '<img src="'.$imageData.'" height="130" width="130" radius="10" />'; echo"</td>";
            }
            echo "<td>".$row['name']."</td>";
            ?>
